            ...
            override fun onCreate(db: SupportSQLiteDatabase) {
                ...
                CoroutineScope(Dispatchers.IO).launch {
                    val activityTypes = listOf(
                        ActivityTypeEntity(name = "Work", iconRes = R.drawable.icon_work),
                        ActivityTypeEntity(name = "Study", iconRes = R.drawable.icon_school),
                        ActivityTypeEntity(name = "Reading", iconRes = R.drawable.icon_book),
                        ActivityTypeEntity(name = "Meditation", iconRes = R.drawable.icon_mind),
                        ActivityTypeEntity(name = "Sport", iconRes = R.drawable.icon_barbell),
                        ActivityTypeEntity(name = "Other", iconRes = R.drawable.icon_other)
                    )
