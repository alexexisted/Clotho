...
class FocusSessionRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun updateFocusSessionReflection(
            sessionId: Long,
            reflectionScore: Int,
        ...
        override fun getAllSessions(): List<FocusSession> =
            focusSessionDao.getAllSessions().map { it.toFocusSessionUIModel() }
        ...
        override suspend fun getAllSessionsWithActivity(): List<FocusSession> =
            focusSessionDao.getAllSessionsWithActivity().map {
                it.toFocusSession()
            }

        override suspend fun getAllSessionsAsUIModels(): List<FocusSessionUIModel> =
            focusSessionDao.getAllSessionsWithActivity().map {
                it.toFocusSessionUIModel()
            }
